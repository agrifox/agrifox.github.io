...
<body style="text-align: right; top: 120px; border-radius: 20px; background-color: #FFFFFF; width: 100%; height: 300px;">
	...
	<br><br><br><br><br><br>
<nav id="nav" style=" color: green; background-color: darkseagreen; width: 99%" align="=right"><a href="home1.html">HOME</a> <a href="">FARMER</a> <a href="wlogin1.py">WHOLESALER</a><a href="contact1.html"> CONTACT US</a></nav>
	<center>
<br>
		<p>&nbsp;</p>
		...
		<br><br>
<div class="container">
<form name="frm" method="post" action="flogin_code.py" class="loginbox">
...
<td align="center"><a class="btn btn-success" href="ffpass.py" role="button">Retrieve your Password</a></td></tr>
<tr>
