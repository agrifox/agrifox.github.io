...
<body style="text-align: right; top: 120px; border-radius: 20px; background-color: #FFFFFF; width: 100%; height: 300px;">
	...
	<br><br><br><br><br><br>
<nav id="nav" style=" color: green; background-color: darkseagreen; width: 99%" align="=right"><a href="home1.html">HOME</a> <a href="wlogin1.py">LOGIN</a></nav>
	<br>
<center>
	<h2><b>Wholesaler Sign Up</b></h2>
<div class="container">
 <form name="user_reg" method="post" action="winsert_code.py">
	 <br>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <td><input type="text" class="form-control" placeholder="Phone Number" name="contact" required></td></tr>
  </div>
  <div class="form-group">
    <tr><td><label>Crops he can Purchase*</label></td>
  ...
  <div class="form-group">
    ...
    <td><input type="text" class="form-control" placeholder="Location Link of your Warehouse" name="location" required></td></tr>
  </div>
  <div class="form-group">
    <tr><td><label>Address*</label></td>
    <td><input type="text" class="form-control" placeholder="Address of your Warehouse" name="address" required></td></tr>
  </div>
  <div class="form-group">
