...
<nav id="nav" style=" color: green; background-color: darkseagreen; width: 100%" align="=right"><a href="home1.html">HOME</a> <a href="flogin1.py">FARMER</a> <a href="wlogin1.py">WHOLESALER</a> <a href="alogin1.py">ADMIN</a> <a href="contact1.html"> CONTACT US</a></nav>
	''')
import marq
print ('''

	<div id="div1" align="center" style="background-image: url('images/field_arable_land_agriculture_hills_road_day_60181_1920x1080.jpg'); color: white; width: 100%; height: 300px; font-family: 'Arial';"><br><br><br><h1>"Investment in Agriculture are the best weapon against hunger and poverty,<br> and they have made life better for billions of people"</h1>
